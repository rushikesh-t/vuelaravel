<template>
  <div class="m-5">
    ...
    <div class="card">
      <h5 class="card-header bg-primary text-white">Update Product</h5>
        ...
        <div class="card-body">
          <form @submit.prevent="submit">
            ...
            <div class="row">
              ...
              <div class="col-2" style="height:100px;">
                <template v-if="image == null">
                  <img
                    src="/upload/image/product/default.png"
                    class="align-self-center bg-light rounded"
            ...
            <div class="row mb-2 mt-2">
              <div class="col-3">
                <button class="btn btn-primary col-11">Update Product</button>
              </div>
            </div>
          </form>
        </div>
...
export default {
  ...
  methods: {
    ...
    loadProduct() {
      let validToken = localStorage.getItem("token");
      const vm = this;
      vm.product.id = this.$route.params.id;
      axios
        .post(
          "/api/getproduct",
          {
        ...
        .then(function(response) {
          ...
          vm.product.productName = data.product_name;
          vm.product.categoryId = data.category_id;
          vm.product.productDescription = data.product_description;
          vm.product.productPrice = data.product_price;
          vm.image = data.product_image;
          vm.isLoading = false;
        })
